...
Public Class AI 'i shall thy the Alfie Alphafish (bit optimistic, I know).
    ...
    Public Function ReturnFENAfterMove(ByVal TempMove As Move) As String
        If HasBeenInstantiated Then
            ...
            Try
                MakeMove(TempBoard, TempMove.OldMoveX, TempMove.OldMoveY, TempMove.NewMoveX, TempMove.NewMoveY, TempMeCanCastle, "00", {0, 0}, TempEnPassant, 0UL)
    ...
    Public Function Search(ByVal Depth As Integer, Optional ByVal UserQuiescence As Boolean = True, Optional ByVal UserPieceHeatMap As Boolean = True) As Move
    ...
    Public Function Search(ByVal Depth As Integer, ByVal PreviousBestMove As Move, Optional ByVal UserQuiescence As Boolean = True, Optional ByVal UserPieceHeatMap As Boolean = True) As Move
